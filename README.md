...
| <a name="input_k8s_charts"></a> [k8s\_charts](#input\_k8s\_charts) | Kubernetes system level applications to be deployed via Helm Charts | <pre>object({<br/>    enabled = optional(bool, false)<br/>    applications = optional(map(object({<br/>      repository       = string<br/>      chart            = string<br/>      version          = string<br/>      namespace        = optional(string, "default")<br/>      create_namespace = optional(bool, true)<br/>      values           = optional(string, "")<br/>      set              = optional(map(string), {})<br/>      atomic           = optional(bool, true)<br/>      wait             = optional(bool, true)<br/>      timeout          = optional(number, 300)<br/>    })), {})<br/>  })</pre> | <pre>{<br/>  "enabled": false<br/>}</pre> | no |
