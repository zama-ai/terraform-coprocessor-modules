...
| <a name="input_manifests_vars"></a> [manifests\_vars](#input\_manifests\_vars) | Computed values injected into additional\_manifests YAML by the root module. Supported placeholders: \_\_region\_\_, \_\_cluster\_name\_\_, \_\_node\_role\_\_. | <pre>object({<br/>    region       = optional(string, "")<br/>    cluster_name = optional(string, "")<br/>    node_role    = optional(string, "")<br/>  })</pre> | `{}` | no |
