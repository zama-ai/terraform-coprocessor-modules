...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ebs_csi_pod_identity"></a> [ebs\_csi\_pod\_identity](#module\_ebs\_csi\_pod\_identity) | terraform-aws-modules/eks-pod-identity/aws | ~> 2.5 |
...
| <a name="output_karpenter_rule_name_prefix"></a> [karpenter\_rule\_name\_prefix](#output\_karpenter\_rule\_name\_prefix) | EventBridge rule name prefix used by Karpenter. Null when Karpenter is disabled. |
| <a name="output_node_security_group_id"></a> [node\_security\_group\_id](#output\_node\_security\_group\_id) | Dedicated security group attached to managed node group ENIs and inherited by Karpenter-launched nodes via the karpenter.sh/discovery tag selector on the EC2NodeClass. |
