...
| <a name="input_rds_master_secret_arn"></a> [rds\_master\_secret\_arn](#input\_rds\_master\_secret\_arn) | ARN of the Secrets Manager secret containing the RDS master user password. Required when any service account sets rds\_secret\_access = true. | `string` | `null` | no |
