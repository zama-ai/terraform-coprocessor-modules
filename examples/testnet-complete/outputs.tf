...
output "vpc_id" {
  ...
  value       = module.coprocessor.vpc_id
}

output "private_subnet_ids" {
  description = "Private subnet IDs."
  value       = module.coprocessor.private_subnet_ids
}
...
output "eks_cluster_name" {
  ...
  value       = module.coprocessor.eks_cluster_name
}

output "eks_cluster_endpoint" {
  description = "EKS cluster API endpoint."
  value       = module.coprocessor.eks_cluster_endpoint
}

output "eks_oidc_provider_arn" {
  description = "OIDC provider ARN for IRSA."
  value       = module.coprocessor.eks_oidc_provider_arn
}

output "eks_karpenter_iam_role_arn" {
  description = "IAM role ARN for the Karpenter controller."
  value       = module.coprocessor.eks_karpenter_iam_role_arn
}

output "eks_karpenter_node_iam_role_arn" {
  description = "IAM role ARN for Karpenter-managed nodes."
  value       = module.coprocessor.eks_karpenter_node_iam_role_arn
}

output "eks_karpenter_queue_name" {
  description = "SQS queue name for Karpenter interruption handling."
  value       = module.coprocessor.eks_karpenter_queue_name
}
...
output "rds_db_instance_endpoint" {
  ...
  value       = module.coprocessor.rds_db_instance_endpoint
}
...
output "s3_bucket_names" {
  ...
  value       = module.coprocessor.s3_bucket_names
}
